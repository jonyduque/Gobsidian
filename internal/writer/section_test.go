...
func TestPatchSectionUnderBOMAndCRLFWritesTheRightBytes(t *testing.T) {
	...
	if err := vault.WriteAtomic(context.Background(), alvo, patched); err != nil {
...
func TestAppendSection_NoteEndAndHeadingEnd(t *testing.T) {
	...
	_ = vault.WriteAtomic(context.Background(), alvo, appendedEnd)
	...
	_ = vault.WriteAtomic(context.Background(), alvo, appendedSec)
