...
// entradas acentuadas, e so isso. O nome anterior, `TestPoolReuse`, e o
// comentario antigo prometiam medir alocacoes ("se o pool estiver
// funcionando, allocs deve ser menor") — nenhuma linha aqui mede
...
func TestNormalizeAcentosECaixa(t *testing.T) {
