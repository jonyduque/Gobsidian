...
//
// Este e o unico teste do arquivo que uma implementacao com
// strings.HasPrefix reprovaria. Se ele for removido ou enfraquecido, a suite
// inteira passa a aceitar o defeito que este pacote existe para impedir.
