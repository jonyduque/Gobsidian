...
// runtimeDirDoSistema e restrictPermission sao o lado Unix (Linux e macOS) do
...
// Windows.
//
// runtimeDirDoSistema prefere XDG_RUNTIME_DIR: em sessoes de usuario modernas no
