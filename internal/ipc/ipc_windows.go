...
// runtimeDirDoSistema e restrictPermission sao o lado Windows do transporte IPC: onde
...
// Unix.
//
// runtimeDirDoSistema usa o mesmo diretorio base que config.defaultCacheDir ja usa
