...
**A meta acima é em 500 notas, que é o corpus do teste. Se a Task 71 já rodou, remeça TAMBÉM no cofre de 5.000** e registre os dois números em `docs/OPERACAO.md`. A ordem de execução do M6 põe a 71 antes desta, justamente para esta tarefa mirar um número real de escala; otimizar contra o corpus pequeno e deixar o grande desatualizado recria o defeito que a 71 existe para fechar.
