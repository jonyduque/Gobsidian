...
"GBS6"`, `cacheCodecVers = 6`) para o mesmo bump, com o mesmo risco: um bump
que esquecesse um dos três produzia um cache que passa pelo cabeçalho e falha
— ou decodifica lixo estruturalmente válido — no corpo.
